...
class CartController extends AbstractController
{
     ...
     */
    public function create(Request $request, CartRepository $cartRepository, OrderManager $orderManager): Response
    {
        $phpSessionId = $request->cookies->get('PHPSESSID');
        $user = $this->getUser();
        $orderManager->createOrderFormCartBySessionId($phpSessionId, $user);
